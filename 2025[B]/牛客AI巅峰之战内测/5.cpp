...
deque<nod>q;
int n,i,j,k,ANS,Hashb[100009],Hashc[100009],p2[100009],ans,Lev,anss;
char c[100009],b[100009];
int tree[1600009],tag[1600009];
...
bool check(int x,int L,int R){
	int ans1,ans2,l,r;
	l=L-x+1;r=L;//c
	ans1=(Hashc[l]-Hashc[r+1]*p2[x]%MOD+MOD)%MOD;
	l=R;r=R+x-1;//b
	ans2=(Hashb[r]-Hashb[l-1]*p2[x]%MOD+MOD)%MOD;
